...
export const ui = {
  ...
  'ui.back':        { en: 'Go back', ko: '뒤로 가기', my: 'ပြန်သွားရန်' },
  ...
  'home.hero.sub': { en: 'MyanMate brings together practical information on visas, jobs, resumes, housing, and everyday life in Korea. Start by reading what you need and consider how it applies to your situation. If questions remain, message us through the channel you prefer.', ko: 'MyanMate는 비자, 일자리, 이력서, 주거와 한국 생활에 필요한 정보를 한곳에 정리합니다. 먼저 필요한 내용을 읽고 내 상황에 맞는지 확인해 보세요. 더 궁금한 점은 편한 채널로 1:1 DM을 보내주세요.', my: 'MyanMate သည် ဗီဇာ၊ အလုပ်အကိုင်၊ ကိုယ်ရေးရာဇဝင်၊ နေအိမ်နှင့် ကိုရီးယားနေ့စဉ်ဘဝအတွက် လိုအပ်သော လက်တွေ့အချက်အလက်များကို တစ်နေရာတည်းတွင် စုစည်းပေးထားပါသည်။ အရင်ဆုံး မိမိလိုအပ်သောအကြောင်းအရာကို ဖတ်ပြီး ကိုယ့်အခြေအနေနှင့် ကိုက်ညီမှုရှိမရှိ စစ်ဆေးကြည့်ပါ။ မရှင်းလင်းသေးတာရှိရင် အဆင်ပြေသော channel မှ 1:1 DM ပို့ပြီး မေးမြန်းနိုင်ပါသည်။' },
  ...
  'home.latest.eyebrow': { en: 'Read first', ko: '먼저 읽어보세요', my: 'အရင်ဆုံး ဖတ်ကြည့်ပါ' },
  'home.latest.title': { en: 'New information from MyanMate', ko: '새로 올라온 정보', my: 'MyanMate မှ အသစ်တင်ထားသော အချက်အလက်များ' },
  'home.latest.lead': { en: 'Start with the newest practical notes and see what connects to your situation.', ko: '가장 최근에 정리한 실용적인 정보부터 읽고, 내 상황과 연결되는 내용을 찾아보세요.', my: 'နောက်ဆုံး စုစည်းထားသော လက်တွေ့အချက်အလက်များကို အရင်ဖတ်ပြီး ကိုယ့်အခြေအနေနှင့် သက်ဆိုင်သောအကြောင်းအရာကို ရှာကြည့်ပါ။' },
  'home.information.eyebrow': { en: 'Find your starting point', ko: '필요한 주제부터', my: 'လိုအပ်သော ခေါင်းစဉ်မှ စတင်ပါ' },
  'home.information.title': { en: 'Browse the information', ko: '정보를 찾아보세요', my: 'အချက်အလက်များကို ရှာဖွေကြည့်ပါ' },
  'home.information.lead': { en: 'Open the category closest to your question. More Korea-life information will continue to be added.', ko: '지금 궁금한 내용과 가장 가까운 카테고리부터 열어보세요. 한국 생활에 필요한 정보는 계속 추가됩니다.', my: 'လက်ရှိသိလိုသည့်အကြောင်းအရာနှင့် အနီးစပ်ဆုံး category ကို အရင်ဖွင့်ကြည့်ပါ။ ကိုရီးယားဘဝအတွက် လိုအပ်သောအချက်အလက်များကို ဆက်လက်ထည့်သွင်းသွားပါမည်။' },
  'home.information.resume.title': { en: 'Resume & job information', ko: '이력서·구직 정보', my: 'ကိုယ်ရေးရာဇဝင်နှင့် အလုပ်အကိုင်အချက်အလက်' },
  'home.information.resume.summary': { en: 'Learn how to structure a Korean resume, describe experience, and find public job information yourself.', ko: '한국식 이력서 구성과 경력 표현 방법, 공개 구직 정보를 직접 확인하는 방법을 정리했습니다.', my: 'ကိုရီးယားပုံစံ ကိုယ်ရေးရာဇဝင်ဖွဲ့စည်းပုံ၊ အတွေ့အကြုံရေးသားပုံနှင့် အများပြည်သူသိနိုင်သော အလုပ်အကိုင်အချက်အလက်များကို ကိုယ်တိုင်ရှာဖွေနည်းကို စုစည်းထားပါသည်။' },
  'home.information.housing.title': { en: 'Home & neighborhood information', ko: '집·주거환경 정보', my: 'အိမ်နှင့် နေထိုင်ရာပတ်ဝန်းကျင် အချက်အလက်' },
  'home.information.housing.summary': { en: 'Review practical points for looking at a home, shared spaces, and the surrounding living environment.', ko: '집 안과 공용공간, 주변 생활환경을 살펴볼 때 참고할 수 있는 정보를 정리했습니다.', my: 'အိမ်အတွင်းပိုင်း၊ အများသုံးနေရာများနှင့် ပတ်ဝန်းကျင်နေထိုင်မှုအခြေအနေကို ကြည့်ရှုရာတွင် ကိုးကားနိုင်သော အချက်အလက်များကို စုစည်းထားပါသည်။' },
  ...
  'home.services.preview.lead': { en: 'After reading the information, open a service to see the kind of preparation and guidance available for a more specific situation.', ko: '정보를 읽은 뒤 내 상황에 더 구체적인 준비가 필요하다면, 각 서비스에서 어떤 안내를 받을 수 있는지 미리 확인해 보세요.', my: 'အချက်အလက်ကို ဖတ်ပြီးနောက် ကိုယ့်အခြေအနေအတွက် ပိုမိုတိကျသောပြင်ဆင်မှုလိုပါက service တစ်ခုစီတွင် ရနိုင်သော လမ်းညွှန်မှုကို အရင်ကြည့်ပါ။' },
  'home.services.preview.recommended': { en: 'A good fit if', ko: '이런 분께', my: 'ဒီလိုသူများအတွက်' },
  'home.services.preview.detail': { en: 'View details', ko: '자세히 보기', my: 'အသေးစိတ် ကြည့်ရန်' },
  'home.services.preview.viewAll': { en: 'View all services', ko: '서비스 전체 보기', my: 'Service အားလုံး ကြည့်ရန်' },
  'home.journey.eyebrow': { en: 'Read, compare, then ask', ko: '읽고, 비교하고, 물어보세요', my: 'ဖတ်ပါ၊ နှိုင်းယှဉ်ပါ၊ ပြီးမှ မေးပါ' },
  'home.journey.lead': { en: 'Use the public information as a starting point, compare it with your own conditions, and send only the questions that remain.', ko: '공개 정보를 출발점으로 삼아 내 조건과 비교해 보고, 그래도 남는 질문만 편한 채널로 보내주세요.', my: 'အများပြည်သူသိနိုင်သောအချက်အလက်ကို အစမှတ်အဖြစ်ယူပြီး ကိုယ့်အခြေအနေနှင့် နှိုင်းယှဉ်ပါ။ မရှင်းလင်းသေးသောမေးခွန်းများကိုသာ အဆင်ပြေသော channel မှ ပို့ပါ။' },
  'home.process.title': { en: 'Use MyanMate in three steps', ko: 'MyanMate 정보는 이렇게 활용하세요', my: 'MyanMate အချက်အလက်ကို ဒီလိုအသုံးပြုပါ' },
  'home.process.step1.title': { en: 'Read the information you need', ko: '필요한 정보를 읽어요', my: 'လိုအပ်သော အချက်အလက်ကို ဖတ်ပါ' },
  'home.process.step1.body': { en: 'Begin with the latest article or the category closest to your question.', ko: '최신 글이나 지금 궁금한 내용과 가까운 카테고리부터 확인합니다.', my: 'နောက်ဆုံးဆောင်းပါး သို့မဟုတ် သိလိုသည့်အကြောင်းအရာနှင့် အနီးစပ်ဆုံး category မှ စတင်ပါ။' },
  'home.process.step2.title': { en: 'Compare it with your situation', ko: '내 상황과 조건을 비교해요', my: 'ကိုယ့်အခြေအနေနှင့် နှိုင်းယှဉ်ပါ' },
  'home.process.step2.body': { en: 'Check which requirements, timing, and priorities actually apply to you.', ko: '요건, 일정과 우선순위가 내 상황에도 적용되는지 하나씩 살펴봅니다.', my: 'လိုအပ်ချက်၊ အချိန်နှင့် ဦးစားပေးအချက်များက ကိုယ့်အခြေအနေနှင့် ကိုက်ညီမှုရှိမရှိ စစ်ဆေးပါ။' },
  'home.process.step3.title': { en: 'Ask only what remains unclear', ko: '남은 질문만 1:1 DM으로 물어요', my: 'မရှင်းလင်းသေးတာကိုသာ 1:1 DM ဖြင့် မေးပါ' },
  'home.process.step3.body': { en: 'Choose Telegram, TikTok, or Facebook Messenger and ask without sending sensitive information.', ko: 'Telegram, TikTok, Facebook Messenger 중 편한 채널에서 민감정보 없이 문의합니다.', my: 'Telegram၊ TikTok သို့မဟုတ် Facebook Messenger မှ အဆင်ပြေသော channel ကိုရွေးပြီး အရေးကြီးကိုယ်ရေးအချက်အလက်များ မပို့ဘဲ မေးပါ။' },
  ...
  'home.about.blurb':    { en: 'MyanMate was created by a Korean partner who understands local systems and context, and a Myanmar partner who has navigated five years of settling in Korea firsthand.', ko: 'MyanMate는 한국의 제도와 현지 맥락을 아는 한국인 파트너와, 5년간 한국 정착을 직접 겪은 미얀마 출신 파트너가 함께 만들었습니다.', my: 'MyanMate ကို ကိုရီးယားစနစ်နှင့် ဒေသတွင်းအခြေအနေကို နားလည်သော ကိုရီးယား partner နှင့် ကိုရီးယားတွင် ၅ နှစ်ကြာ ကိုယ်တိုင်အခြေချနေထိုင်ခဲ့သော မြန်မာ partner တို့ အတူဖန်တီးခဲ့ပါသည်။' },
  ...
  /* 3. Guides */
  'infoHub.eyebrow': { en: 'Korea guide library', ko: '한국 생활 가이드 라이브러리', my: 'ကိုရီးယား Guide Library' },
  'infoHub.title': { en: 'Korea Guides for Myanmar People', ko: '미얀마 사람을 위한 한국 가이드', my: 'မြန်မာလူမျိုးများအတွက် လမ်းညွှန်များ' },
  'infoHub.intro': { en: 'Guides for Myanmar people who live in Korea, are preparing to come, or want to understand Korea before deciding.', ko: '한국에 살고 있거나, 오려고 준비 중이거나, 결정 전에 한국을 알고 싶은 미얀마 사람을 위한 가이드입니다.', my: 'ကိုရီးယားမှာ နေနေသူ၊ လာဖို့ပြင်နေသူ၊ ဒါမှမဟုတ် မဆုံးဖြတ်ခင် အရင်သိချင်သူတွေအတွက် လိုအပ်နိုင်တဲ့အချက်အလက်တွေကို ခေါင်းစဉ်အလိုက် စုထားပါတယ်။' },
  'infoHub.choose': { en: 'What do you want to check?', ko: '무엇을 확인할까요?', my: 'လိုအပ်တဲ့ ခေါင်းစဉ်ကို ရွေးပါ' },
  'infoHub.chooseNote': { en: 'Choose a topic. Inside each guide, you can continue to related blog posts or service help when you need personal support.', ko: '주제를 선택하세요. 각 가이드 안에서 관련 블로그와 개인 도움이 필요할 때 이용할 수 있는 서비스까지 이어서 볼 수 있습니다.', my: 'လိုတဲ့အကြောင်းအရာကို ရွေးပါ။ Guide ထဲမှာ သက်ဆိုင်တဲ့ blog post တွေ၊ အကူအညီလိုရင် service လမ်းကြောင်းတွေကို ဆက်ဖတ်နိုင်ပါတယ်။' },
  'infoHub.card.badge': { en: 'Open guide', ko: '가이드 열기', my: 'Guide ဖွင့်ရန်' },
  'infoHub.promise.note': { en: 'For details that can change, we remind you to check official sources. We do not include illegal shortcuts or decide personal cases.', ko: '바뀔 수 있는 내용은 공식 출처 확인을 안내하고, 불법 우회 방법이나 개인 사건에 대한 단정은 다루지 않습니다.', my: 'ပြောင်းနိုင်တဲ့အချက်တွေမှာ တရားဝင်ရင်းမြစ်ကို ပြန်စစ်ဖို့ သတိပေးထားပြီး၊ ဥပဒေမညီတဲ့ shortcut များကို မထည့်ပါဘူး။' },
  ...
  'infoTopic.publicBadge': { en: 'Public information', ko: '공개 정보', my: 'အများပြည်သူသုံး အချက်အလက်' },
  'infoTopic.disclaimer.title': { en: 'Check the latest official information', ko: '최신 공식 정보를 확인하세요', my: 'နောက်ဆုံး တရားဝင်အချက်အလက်ကို စစ်ဆေးပါ' },
  'infoTopic.disclaimer.body': { en: 'This page organizes general public information for convenient reference. Dates, requirements, procedures, and institutional rules can change, so confirm the latest details through the linked official source before use.', ko: '이 페이지는 누구나 확인할 수 있는 일반 공개 정보를 편리하게 정리한 안내입니다. 기한·요건·절차와 기관 기준은 바뀔 수 있으므로 이용 전 연결된 공식 확인처에서 최신 내용을 다시 확인하세요.', my: 'ဤစာမျက်နှာသည် လူတိုင်းကြည့်ရှုနိုင်သော ယေဘုယျအများပြည်သူသုံး အချက်အလက်များကို အလွယ်တကူ ကိုးကားနိုင်ရန် စုစည်းထားခြင်းဖြစ်ပါသည်။ သတ်မှတ်ရက်၊ လိုအပ်ချက်၊ လုပ်ငန်းစဉ်နှင့် အဖွဲ့အစည်းစည်းမျဉ်းများ ပြောင်းလဲနိုင်သောကြောင့် အသုံးမပြုမီ ချိတ်ဆက်ထားသော တရားဝင်ရင်းမြစ်တွင် နောက်ဆုံးအချက်အလက်ကို ပြန်လည်စစ်ဆေးပါ။' },
  'infoTopic.disclaimer.boundary': { en: 'MyanMate does not complete registrations, reservations, applications, or payments for readers.', ko: 'MyanMate는 독자의 등록·예약·신청·결제를 처리하지 않습니다.', my: 'MyanMate သည် ဖတ်ရှုသူများ၏ မှတ်ပုံတင်ခြင်း၊ ကြိုတင်စာရင်းသွင်းခြင်း၊ လျှောက်ထားခြင်း သို့မဟုတ် ငွေပေးချေခြင်းကို ဆောင်ရွက်ပေးခြင်း မရှိပါ။' },
  'infoTopic.back': { en: 'Back to all information', ko: '전체 정보로 돌아가기', my: 'အချက်အလက်အားလုံးသို့ ပြန်သွားရန်' },
  ...
  'guides.filter.study':   { en: 'Study',      ko: '유학',     my: 'ပညာသင်' },
  ...
  'visaPurpose.label': { en: 'Visa purpose filter', ko: '비자 목적 필터', my: 'ဗီဇာရည်ရွယ်ချက် ရွေးချယ်ရန်' },
  'visaPurpose.all': { en: 'All', ko: '전체', my: 'အားလုံး' },
  'visaPurpose.study': { en: 'Study', ko: '학업', my: 'ပညာသင်' },
  'visaPurpose.work': { en: 'Work', ko: '취업', my: 'အလုပ်' },
  'visaPurpose.residence': { en: 'Residence', ko: '거주', my: 'နေထိုင်' },
  'visaPurpose.other': { en: 'Other', ko: '기타', my: 'အခြား' },
  'visaPurpose.note': { en: 'Grouped by the main purpose of stay. Visa names and requirements can change, so confirm the latest details with official sources before applying.', ko: '주된 체류 목적별로 묶었습니다. 체류자격 명칭과 요건은 바뀔 수 있으므로 신청 전 공식 출처에서 최신 내용을 확인하세요.', my: 'အဓိကနေထိုင်ရည်ရွယ်ချက်အလိုက် စုစည်းထားပါသည်။ ဗီဇာအမည်နှင့် လိုအပ်ချက်များ ပြောင်းလဲနိုင်သောကြောင့် မလျှောက်မီ တရားဝင်ရင်းမြစ်တွင် နောက်ဆုံးအချက်အလက်ကို စစ်ဆေးပါ။' },
  'visaPurpose.empty.title': { en: 'No guide in this purpose yet.', ko: '이 목적의 가이드는 아직 준비 중입니다.', my: 'ဤရည်ရွယ်ချက်အတွက် Guide မရှိသေးပါ။' },
  'visaPurpose.empty.body': { en: 'We will add more visa guides as they are prepared. For now, check another purpose or contact us if you need help finding the right direction.', ko: '준비되는 대로 비자 가이드를 추가하겠습니다. 지금은 다른 목적을 확인하거나 방향을 찾는 데 도움이 필요하면 문의하세요.', my: 'ပြင်ဆင်ပြီးသည့်အခါ ဗီဇာ Guide များကို ထပ်မံထည့်သွင်းပါမည်။ ယခုအချိန်တွင် အခြားရည်ရွယ်ချက်ကို ကြည့်ပါ၊ သို့မဟုတ် လမ်းကြောင်းရွေးချယ်ရန် အကူအညီလိုပါက မေးမြန်းပါ။' },
  ...
  'dm.messenger': { en: 'Message on Facebook Messenger', ko: 'Facebook Messenger로 문의', my: 'Facebook Messenger မှ မေးမြန်းရန်' },
  'dm.note': { en: 'Do not send passport numbers, ID numbers, financial information, or document photos in any message.', ko: '문의 과정에서는 여권번호·외국인등록번호·금융정보·서류 사진을 보내지 마세요.', my: 'မေးမြန်းသည့် မည်သည့်မက်ဆေ့တွင်မဆို Passport နံပါတ်၊ ID နံပါတ်၊ ငွေကြေးအချက်အလက် သို့မဟုတ် စာရွက်စာတမ်းဓာတ်ပုံများကို မပို့ပါနှင့်။' },
  ...
  'content.section.study.documents': { en: 'Items You May Need', ko: '준비할 수 있는 항목', my: 'လိုအပ်နိုင်သောအရာများ' },
  ...
  'content.disclaimer.study': { en: 'This is general study information. Test dates, fees, score rules, and school requirements can change, so confirm with the official TOPIK site, test center, school, or scholarship notice before acting.', ko: '일반 유학 정보입니다. 시험일, 응시료, 성적 인정 기준, 학교별 요건은 바뀔 수 있으므로 행동하기 전 공식 TOPIK 사이트, 시험장, 학교 또는 장학금 공지를 확인하세요.', my: 'ဤအချက်အလက်သည် ယေဘုယျ ပညာသင်အချက်အလက်ဖြစ်ပါသည်။ စာမေးပွဲနေ့၊ Fee၊ Score rule နှင့် ကျောင်းလိုအပ်ချက်များ ပြောင်းနိုင်သောကြောင့် လုပ်ဆောင်မီ တရားဝင် TOPIK site၊ စာမေးပွဲစင်တာ၊ ကျောင်း သို့မဟုတ် Scholarship notice တွင် ပြန်စစ်ပါ။' },
  ...
  'svcDetail.section.included': { en: 'What MyanMate will do', ko: 'MyanMate가 도와드리는 일', my: 'MyanMate က ဘာကူညီပေးမလဲ' },
  'svcDetail.section.process': { en: 'How it works', ko: '어떻게 진행하나요', my: 'ဘယ်လို ဆောင်ရွက်သလဲ' },
  'svcDetail.section.deliverables': { en: 'What the customer receives', ko: '고객이 받는 것', my: 'Customer ဘာတွေ ရမလဲ' },
  'svcDetail.section.preparation': { en: 'What the customer needs to provide', ko: '고객이 준비할 것', my: 'Customer ဘာတွေ ပေးရန်လိုမလဲ' },
  'svcDetail.section.whatWeDont':  { en: 'What is not included', ko: '포함되지 않는 것', my: 'မပါဝင်သောအရာများ' },
  ...
  'svcDetail.boundary.part-time-job': { en: 'We help prepare application materials and explain public job posts. We do not find jobs for you, apply for you, or guarantee hiring.', ko: '지원 자료 준비와 공개 채용공고 이해를 돕습니다. 일자리를 찾아주거나 대신 지원하거나 채용을 보장하지 않습니다.', my: 'အလုပ်လျှောက်ရန်လိုအပ်သောအရာများ ပြင်ဆင်ရန်နှင့် public job post ကို နားလည်ရန် ကူညီပါသည်။ အလုပ်ရှာပေးခြင်း၊ ကိုယ်စားလျှောက်ပေးခြင်း၊ အလုပ်ရမည်ဟု အာမခံခြင်း မပြုလုပ်ပါ။' },
  'svcDetail.boundary.career': { en: 'We help improve career application materials and interview readiness. We do not apply for you, contact employers for you, or guarantee interviews or hiring.', ko: '전문직 지원 자료와 면접 준비를 돕습니다. 대신 지원하거나 회사에 연락하거나 면접·채용을 보장하지 않습니다.', my: 'Professional အလုပ်လျှောက်ရန် စာရွက်စာတမ်းနှင့် interview ပြင်ဆင်မှုကို ကူညီပါသည်။ ကိုယ်စားလျှောက်ခြင်း၊ employer ကို ဆက်သွယ်ပေးခြင်း၊ interview သို့မဟုတ် အလုပ်ရမည်ဟု အာမခံခြင်း မပြုလုပ်ပါ။' },
  'svcDetail.boundary.interview': { en: 'We coach interview practice using the job post you found and your truthful experience. We do not find employers, contact them, apply for you, or guarantee an interview or hiring.', ko: '고객이 직접 찾은 채용공고와 실제 경험을 바탕으로 면접 연습과 피드백을 제공합니다. 일자리를 찾아주거나 고용주에게 연락하거나 대신 지원하거나 면접·채용을 보장하지 않습니다.', my: 'သင်ကိုယ်တိုင်ရှာထားသော job post နှင့် အမှန်တကယ် experience ကို အခြေခံ၍ interview လေ့ကျင့်မှုနှင့် feedback ပေးပါသည်။ Employer ရှာပေးခြင်း၊ ဆက်သွယ်ပေးခြင်း၊ ကိုယ်စားလျှောက်ပေးခြင်း သို့မဟုတ် interview နှင့် အလုပ်ရမည်ဟု အာမခံခြင်း မပြုလုပ်ပါ။' },
  'svcDetail.boundary.portfolio': { en: 'We help plan, review, and create portfolio materials. We do not invent experience, guarantee hiring, or host paid services unless agreed separately.', ko: '포트폴리오 기획·검토·제작을 돕습니다. 경험을 만들어내거나 채용을 보장하거나 별도 합의 없는 유료 호스팅을 제공하지 않습니다.', my: 'Portfolio ကို စီစဉ်၊ စစ်ဆေး၊ ဖန်တီးရန် ကူညီပါသည်။ မရှိသော experience ကို ဖန်တီးပေးခြင်း၊ အလုပ်ရမည်ဟု အာမခံခြင်း၊ သီးခြားသဘောတူချက်မရှိဘဲ paid hosting ပေးခြင်း မလုပ်ပါ။' },
  ...
  'request.lead':  { en: 'Choose Telegram, TikTok, or Facebook Messenger. We will continue the conversation in the channel you select.', ko: 'Telegram, TikTok, Facebook Messenger 중 편한 채널을 선택하세요. 선택한 채널에서 1:1로 대화를 이어갑니다.', my: 'Telegram၊ TikTok သို့မဟုတ် Facebook Messenger ထဲမှ အဆင်ပြေသော channel ကို ရွေးပါ။ ရွေးထားသော channel တွင် 1:1 စကားပြောပါမည်။' },
  'request.trust.noSensitive.title': { en: 'No sensitive information needed', ko: '민감정보는 필요 없어요', my: 'အရေးကြီးကိုယ်ရေးအချက်အလက်များ မလိုပါ' },
  ...
  'request.trust.dm.body': { en: 'Telegram, TikTok, and Facebook Messenger are available.', ko: 'Telegram, TikTok, Facebook Messenger로 문의할 수 있어요.', my: 'Telegram၊ TikTok နှင့် Facebook Messenger ဖြင့် မေးမြန်းနိုင်ပါသည်။' },
  ...
  'about.story.chapter3.body': { en: 'One of our partners is Burmese. They have lived in Korea for five years and experienced student life, work, and everyday settlement firsthand. The other partner is Korean. They understand local systems, law, and how real cases are handled in Korea. Together, the two partners turn experience and public information into practical guidance.', ko: '파트너 중 한 명은 미얀마인입니다. 한국에서 5년 동안 살며 유학생활, 일, 일상 정착을 직접 경험한 사람이죠. 다른 파트너는 한국인입니다. 한국 현지 제도와 법, 실제 사례가 처리되는 맥락을 이해합니다. 두 파트너가 함께 경험과 공개 정보를 실용적인 안내로 바꿉니다.', my: 'Partner တစ်ဦးမှာ မြန်မာလူမျိုး ဖြစ်ပါသည်။ ကိုရီးယားတွင် ၅ နှစ်ကြာ နေထိုင်ပြီး ကျောင်းသားဘဝ၊ အလုပ်နှင့် နေ့စဉ်အခြေချနေထိုင်မှုကို ကိုယ်တိုင်ကြုံတွေ့ခဲ့သူ ဖြစ်ပါသည်။ အခြား partner တစ်ဦးမှာ ကိုရီးယားလူမျိုး ဖြစ်ပါသည်။ ကိုရီးယားဒေသတွင်းစနစ်များ၊ ဥပဒေများနှင့် လက်တွေ့ကိစ္စများကို မည်သို့ကိုင်တွယ်သည်ကို နားလည်ပါသည်။ Partner နှစ်ဦးက အတွေ့အကြုံနှင့် အများပြည်သူသိနိုင်သောအချက်အလက်များကို လက်တွေ့ကျသော လမ်းညွှန်မှုအဖြစ် အတူပြောင်းလဲပေးပါသည်။' },
  ...
  'about.proof.item2': { en: '5 years of lived Korea experience', ko: '5년의 실제 한국 생활 경험', my: 'ကိုရီးယားတွင် ၅ နှစ် နေထိုင်ဖူးသည့် အတွေ့အကြုံ' },
  ...
  'about.cta.note': { en: 'Start with the guides. If your situation is still unclear, choose a DM channel and ask.', ko: '먼저 정보를 확인해 보세요. 그래도 내 상황이 불확실하다면 편한 DM 채널로 문의하세요.', my: 'လမ်းညွှန်ချက်များဖြင့် စတင်ပါ။ သင့်အခြေအနေမှာ မသေချာသေးပါက အဆင်ပြေသော DM channel တစ်ခုကို ရွေးပြီး မေးမြန်းပါ။' },
  ...
  'privacy.processors.body':  { en: 'Telegram, TikTok, and Facebook Messenger messages are processed by their respective platform providers. Each provider may process data under its own privacy policy.', ko: 'Telegram, TikTok, Facebook Messenger 메시지는 각 플랫폼 제공업체가 처리하며, 각자의 개인정보 처리방침이 적용될 수 있습니다.', my: 'Telegram၊ TikTok နှင့် Facebook Messenger မက်ဆေ့များကို သက်ဆိုင်ရာ platform ပံ့ပိုးသူများက ဆောင်ရွက်ပြီး ၎င်းတို့၏ ကိုယ်ရေးအချက်အလက်မူဝါဒများ သက်ရောက်နိုင်ပါသည်။' },
  ...
  'ui.tag.partTimeJob': { en: 'Part-time job', ko: '알바 지원', my: 'Part-time အလုပ်' },
  'ui.tag.careerSupport': { en: 'Career support', ko: '커리어 지원', my: 'Career အကူအညီ' },
  'ui.tag.interviewCoaching': { en: 'Interview coaching', ko: '면접 코칭', my: 'Interview coaching' },
  'ui.tag.portfolioSupport': { en: 'Portfolio', ko: '포트폴리오', my: 'Portfolio' },
