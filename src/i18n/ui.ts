...
export const ui = {
  ...
  'home.information.housing.title': { en: 'Housing & living-area information', ko: '주거·생활환경 정보', my: 'နေအိမ်နှင့် ပတ်ဝန်းကျင်နေထိုင်မှု အချက်အလက်' },
  ...
  'home.services.lead': { en: 'Short, practical support for job applications, portfolios, study preparation, and home viewing.', ko: '지원서, 포트폴리오, 유학 준비와 집 보기를 위한 짧고 실용적인 지원입니다.', my: 'အလုပ်လျှောက်ရန်၊ portfolio ပြင်ရန်၊ ကျောင်းတက်ရန်နှင့် အိမ်ကြည့်ရန် လက်တွေ့ကျသော အကူအညီများ။' },
  ...
  'svcDetail.boundary.study': { en: 'We help organize study application preparation. You confirm final admission, visa, and school requirements with the school, embassy, Immigration, or official source.', ko: '유학 지원 준비를 정리하도록 돕습니다. 최종 입학·비자·학교 요건은 학교, 대사관, 출입국 또는 공식 확인처에서 직접 확인합니다.', my: 'ကျောင်းလျှောက်ရန် ပြင်ဆင်မှုကို စနစ်တကျဖြစ်အောင် ကူညီပါသည်။ နောက်ဆုံး admission၊ visa နှင့် school လိုအပ်ချက်များကို ကျောင်း၊ သံရုံး၊ လူဝင်မှုကြီးကြပ်ရေး သို့မဟုတ် တရားဝင်နေရာတွင် ကိုယ်တိုင်အတည်ပြုပါ။' },
  ...
  'ui.tag.studySupport': { en: 'Study in Korea', ko: '한국 유학', my: 'ကိုရီးယား ကျောင်း' },
