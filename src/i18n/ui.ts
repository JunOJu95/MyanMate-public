...
export const ui = {
  ...
  'about.lead':  { en: 'MyanMate began with one visa change we had to work through ourselves, and the questions that kept arriving afterward.', ko: '직접 겪은 한 번의 비자 변경과, 그 뒤 반복해서 도착한 질문에서 MyanMate가 시작됐습니다.', my: 'ကျွန်ုပ်တို့ကိုယ်တိုင် ဖြေရှင်းခဲ့ရသော ဗီဇာပြောင်းလဲမှုတစ်ခုနှင့် နောက်ပိုင်း ဆက်တိုက်ရောက်လာသော မေးခွန်းများမှ MyanMate စတင်ခဲ့ပါသည်။' },
  'about.story.title': { en: 'Why we started MyanMate', ko: '우리가 MyanMate를 시작한 이유', my: 'MyanMate ကို ဘကြောင့် စတင်ခဲ့တာလဲ?' },
  'about.story.intro': { en: 'This is the story of a Myanmar co-founder navigating Korea’s visa system, and two co-founders turning that experience into information others could use.', ko: '미얀마 출신 공동창업자가 한국의 비자 제도를 직접 통과하며 겪은 경험과, 두 공동창업자가 그 경험을 다른 사람도 활용할 수 있는 정보로 바꿔온 이야기입니다.', my: 'မြန်မာနိုင်ငံမှ ပူးတွဲတည်ထောင်သူတစ်ဦးက ကိုရီးယားဗီဇာစနစ်ကို ကိုယ်တိုင်ဖြတ်သန်းခဲ့သည့် အတွေ့အကြုံနှင့် ထိုအတွေ့အကြုံကို အခြားသူများ အသုံးချနိုင်သော အချက်အလက်အဖြစ် ပူးတွဲတည်ထောင်သူနှစ်ဦးက ပြောင်းလဲလာခဲ့သည့် ဇာတ်လမ်းဖြစ်ပါသည်။' },
  'about.story.chapter1.label': { en: '01 · The first barrier', ko: '01 · 처음 마주한 장벽', my: '01 · ပထမဆုံး ကြုံတွေ့ခဲ့ရသော အခက်အခဲ' },
  'about.story.chapter1.title': { en: 'Information existed, but not in a language we could trust', ko: '정보는 있었지만, 믿고 이해할 수 있는 언어가 없었습니다', my: 'အချက်အလက်ရှိသော်လည်း ယုံကြည်စိတ်ချစွာ နားလည်နိုင်သည့် ဘာသာစကားမရှိခဲ့ပါ' },
  'about.story.chapter1.body': { en: 'When our Myanmar co-founder was still new to life in Korea, most official visa information was written in unfamiliar Korean administrative language. Reliable explanations in Myanmar were hard to find, while translated pages and community posts made it difficult to tell what was current or accurate. Even with the information in front of us, deciding what applied to the situation was the harder part.', ko: '미얀마 출신 공동창업자가 한국 생활을 시작한 초기에는 공식 비자 정보 대부분이 익숙하지 않은 한국어 행정 용어로 적혀 있었습니다. 신뢰할 수 있는 미얀마어 설명은 찾기 어려웠고, 번역된 페이지와 커뮤니티 글만으로는 어떤 내용이 최신이고 정확한지 판단하기도 쉽지 않았습니다. 정보가 눈앞에 있어도 내 상황에 적용되는 내용을 가려내는 일이 더 어려웠습니다.', my: 'မြန်မာနိုင်ငံမှ ပူးတွဲတည်ထောင်သူက ကိုရီးယားဘဝကို စတင်ခါစတွင် တရားဝင်ဗီဇာအချက်အလက်အများစုကို မရင်းနှီးသော ကိုရီးယားအုပ်ချုပ်ရေးအသုံးအနှုန်းများဖြင့် ရေးသားထားပါသည်။ ယုံကြည်ရသော မြန်မာဘာသာရှင်းလင်းချက်များ ရှာဖွေရခက်ပြီး ဘာသာပြန်စာမျက်နှာများနှင့် community post များမှ မည်သည့်အချက်အလက်က နောက်ဆုံးနှင့် မှန်ကန်သည်ကို ခွဲခြားရန်လည်း မလွယ်ကူခဲ့ပါ။ အချက်အလက်ကို မြင်နေရသော်လည်း မိမိအခြေအနေနှင့် ကိုက်ညီသည့်အရာကို ဆုံးဖြတ်ရခြင်းက ပိုခက်ခဲခဲ့ပါသည်။' },
  'about.story.chapter2.label': { en: '02 · A visa change that took days to understand', ko: '02 · 며칠이 걸린 비자 변경', my: '02 · နားလည်ရန် ရက်အနည်းငယ်ကြာခဲ့သော ဗီဇာပြောင်းလဲမှု' },
  'about.story.chapter2.title': { en: 'Changing from D-10 to E-7-1 took two to three days of checking', ko: 'D-10에서 E-7-1으로 변경하는 데 2~3일의 확인이 필요했습니다', my: 'D-10 မှ E-7-1 သို့ ပြောင်းရန် နှစ်ရက်မှ သုံးရက်အထိ စစ်ဆေးခဲ့ရပါသည်' },
  'about.story.chapter2.body': { en: 'For the change from D-10 to E-7-1, we read the manuals on HiKorea and called HiKorea to confirm the points that were still unclear. It took two to three days to connect the requirements, documents, and order of steps. After checking the official information, our Myanmar co-founder completed the application and visa change personally.', ko: 'D-10에서 E-7-1으로 체류자격을 변경할 때는 하이코리아 웹사이트의 매뉴얼을 읽고, 이해되지 않는 부분은 하이코리아에 전화해 다시 확인했습니다. 요건과 서류, 진행 순서를 하나로 연결하는 데 2~3일이 걸렸습니다. 공식 정보를 확인한 뒤 미얀마 출신 공동창업자가 직접 신청을 진행해 비자 변경을 마쳤습니다.', my: 'D-10 မှ E-7-1 သို့ နေထိုင်ခွင့်ပြောင်းရာတွင် HiKorea website ရှိ လက်စွဲစာအုပ်များကို ဖတ်ပြီး မရှင်းလင်းသေးသည့်အချက်များကို HiKorea သို့ ဖုန်းဆက်၍ ထပ်မံအတည်ပြုခဲ့ပါသည်။ လိုအပ်ချက်များ၊ စာရွက်စာတမ်းများနှင့် လုပ်ဆောင်ရမည့်အစီအစဉ်ကို ဆက်စပ်နားလည်ရန် နှစ်ရက်မှ သုံးရက်အထိ ကြာခဲ့ပါသည်။ တရားဝင်အချက်အလက်ကို စစ်ဆေးပြီးနောက် မြန်မာနိုင်ငံမှ ပူးတွဲတည်ထောင်သူက ကိုယ်တိုင်လျှောက်ထား၍ ဗီဇာပြောင်းလဲမှုကို ပြီးမြောက်ခဲ့ပါသည်။' },
  'about.story.quote': { en: 'The problem was not that information did not exist. It was finding information we could apply to our own situation.', ko: '정보가 없는 것보다, 내 상황에 적용할 수 있는 정보를 찾기 어려웠습니다.', my: 'အချက်အလက်မရှိခြင်းထက် မိမိအခြေအနေနှင့် အသုံးချနိုင်သော အချက်အလက်ကို ရှာဖွေရခြင်းက ပိုခက်ခဲခဲ့ပါသည်။' },
  'about.story.chapter3.label': { en: '03 · From experience to TikTok', ko: '03 · 경험에서 TikTok으로', my: '03 · အတွေ့အကြုံမှ TikTok သို့' },
  'about.story.chapter3.title': { en: 'We started explaining what we had learned in simpler terms', ko: '직접 알게 된 내용을 더 쉽게 풀어보기 시작했습니다', my: 'ကိုယ်တိုင်သိရှိခဲ့သည့်အရာများကို ပိုလွယ်ကူစွာ ရှင်းပြလာခဲ့ပါသည်' },
  'about.story.chapter3.body': { en: 'We began posting visa videos on TikTok to introduce MyanMate and to help other Myanmar people use what we had learned as a starting point. Instead of repeating administrative language, we tried to explain what the information meant and what viewers should confirm for themselves.', ko: 'MyanMate를 알리는 동시에, 같은 문제를 겪는 미얀마 사람들이 우리의 경험을 출발점으로 활용할 수 있도록 TikTok에 비자 영상을 올리기 시작했습니다. 행정 용어를 그대로 반복하기보다 그 정보가 무엇을 의미하는지, 시청자가 직접 무엇을 확인해야 하는지 쉽게 설명하려고 했습니다.', my: 'MyanMate ကို မိတ်ဆက်ရန်နှင့် အလားတူအခက်အခဲကြုံရသော မြန်မာလူမျိုးများက ကျွန်ုပ်တို့၏ အတွေ့အကြုံကို အစအဖြစ် အသုံးချနိုင်ရန် TikTok တွင် ဗီဇာ video များ စတင်တင်ခဲ့ပါသည်။ အုပ်ချုပ်ရေးအသုံးအနှုန်းများကို ထပ်ပြောရုံမဟုတ်ဘဲ အချက်အလက်၏ အဓိပ္ပာယ်နှင့် ကြည့်ရှုသူက ကိုယ်တိုင်စစ်ဆေးရမည့်အရာများကို လွယ်ကူစွာ ရှင်းပြရန် ကြိုးစားခဲ့ပါသည်။' },
  'about.story.chapter4.label': { en: '04 · The questions that kept coming', ko: '04 · 반복해서 도착한 질문', my: '04 · ဆက်တိုက်ရောက်လာသော မေးခွန်းများ' },
  'about.story.chapter4.title': { en: 'One video could not answer every situation', ko: '영상 하나로는 각자의 상황에 답할 수 없었습니다', my: 'Video တစ်ခုတည်းဖြင့် လူတိုင်း၏ အခြေအနေကို မဖြေနိုင်ခဲ့ပါ' },
  'about.story.chapter4.body': { en: 'The comments and DMs kept asking, “Does this also apply to my situation?” and “What should I do next?” The visa name might be the same, but the points to check could change with a person’s education, work, documents, and current status. That was when we understood that clear general information and questions about an individual situation had to be handled differently.', ko: '댓글과 DM에는 “제 상황에도 이 내용이 적용되나요?”, “저는 다음에 무엇을 해야 하나요?”라는 질문이 반복해서 도착했습니다. 같은 비자라도 학력, 일, 준비된 서류와 현재 체류 상황에 따라 확인할 내용이 달라질 수 있었습니다. 그때 기본 정보를 분명하게 정리하는 일과 개인의 상황에 맞춰 확인할 질문을 짚는 일이 서로 다르게 필요하다는 것을 알게 됐습니다.', my: 'Comment နှင့် DM များတွင် “ဒီအချက်က ကျွန်တော့်အခြေအနေနှင့်လည်း သက်ဆိုင်ပါသလား”၊ “နောက်တစ်ဆင့် ဘာလုပ်ရမလဲ” ဟူသော မေးခွန်းများ ဆက်တိုက်ရောက်လာခဲ့ပါသည်။ ဗီဇာအမည်တူသော်လည်း ပညာရေး၊ အလုပ်၊ ပြင်ဆင်ထားသော စာရွက်စာတမ်းနှင့် လက်ရှိနေထိုင်ခွင့်အခြေအနေပေါ်မူတည်၍ စစ်ဆေးရမည့်အချက်များ ကွဲပြားနိုင်ပါသည်။ ထိုအချိန်တွင် အခြေခံအချက်အလက်ကို ရှင်းလင်းစွာ စီစဉ်ခြင်းနှင့် လူတစ်ဦးချင်းအခြေအနေအတွက် စစ်ဆေးရမည့်မေးခွန်းများကို ဖော်ထုတ်ခြင်းတို့ကို သီးခြားလိုအပ်ကြောင်း နားလည်ခဲ့ပါသည်။' },
  'about.story.chapter5.label': { en: '05 · The start of MyanMate', ko: '05 · MyanMate의 시작', my: '05 · MyanMate ၏ အစ' },
  'about.story.chapter5.title': { en: 'We built the place we had needed ourselves', ko: '우리가 필요했던 정보 공간을 직접 만들기로 했습니다', my: 'ကျွန်ုပ်တို့ကိုယ်တိုင် လိုအပ်ခဲ့သော အချက်အလက်နေရာကို ဖန်တီးရန် ဆုံးဖြတ်ခဲ့ပါသည်' },
  'about.story.chapter5.body': { en: 'A Myanmar co-founder who has lived through settlement in Korea and a Korean co-founder familiar with local systems began building MyanMate together. We organize public information so it is easier to understand in Myanmar, and point to the questions and official sources that still need confirmation. Our role is to research and explain; every application and decision remains with the person making it.', ko: '한국 정착 과정을 직접 겪은 미얀마 출신 공동창업자와 한국의 제도와 현지 맥락을 아는 한국인 공동창업자가 함께 MyanMate를 만들기 시작했습니다. 공개된 정보를 미얀마어로도 이해하기 쉽게 정리하고, 추가로 확인할 질문과 공식 확인처를 안내합니다. 저희는 정보를 조사하고 설명하며, 모든 신청과 결정은 이용자가 직접 진행합니다.', my: 'ကိုရီးယားတွင် အခြေချနေထိုင်မှုကို ကိုယ်တိုင်ကြုံတွေ့ခဲ့သော မြန်မာနိုင်ငံမှ ပူးတွဲတည်ထောင်သူနှင့် ကိုရီးယားစနစ်နှင့် ဒေသဆိုင်ရာအခြေအနေကို နားလည်သော ကိုရီးယားပူးတွဲတည်ထောင်သူတို့က MyanMate ကို အတူတကွ စတင်တည်ဆောက်ခဲ့ပါသည်။ အများပြည်သူသိနိုင်သော အချက်အလက်များကို မြန်မာဘာသာဖြင့်လည်း နားလည်လွယ်အောင် စီစဉ်ပြီး ထပ်မံစစ်ဆေးရန်မေးခွန်းများနှင့် တရားဝင်ရင်းမြစ်များကို ညွှန်ပြပါသည်။ ကျွန်ုပ်တို့၏အခန်းကဏ္ဍမှာ အချက်အလက်ရှာဖွေ၍ ရှင်းပြခြင်းဖြစ်ပြီး လျှောက်ထားမှုနှင့် ဆုံးဖြတ်ချက်အားလုံးကို အသုံးပြုသူက ကိုယ်တိုင် ဆောင်ရွက်ပါသည်။' },
  'about.name.label': { en: 'The name we chose', ko: '우리가 고른 이름', my: 'ကျွန်ုပ်တို့ ရွေးချယ်ခဲ့သော အမည်' },
  'about.name.title': { en: 'MyanMate = Myanmar + Mate', ko: 'MyanMate = Myanmar + Mate', my: 'MyanMate = Myanmar + Mate' },
  'about.name.body': { en: 'The name carries the idea of a mate beside Myanmar people settling in Korea: someone who helps make unfamiliar information easier to understand, while leaving every choice in their hands.', ko: '낯선 한국 생활에서 미얀마인이 정보를 더 쉽게 이해할 수 있도록 곁에서 돕되, 선택은 언제나 본인이 할 수 있게 하는 친구라는 뜻을 이름에 담았습니다.', my: 'ကိုရီးယားတွင် အခြေချနေထိုင်သော မြန်မာလူမျိုးများအတွက် မရင်းနှီးသောအချက်အလက်ကို ပိုမိုနားလည်လွယ်စေရန် ဘေးမှကူညီပေးပြီး ရွေးချယ်မှုတိုင်းကို မိမိလက်ထဲတွင် ထားနိုင်စေသော မိတ်ဆွေဟူသည့် အဓိပ္ပာယ်ကို ဤအမည်တွင် ထည့်သွင်းထားပါသည်။' },
  'about.name.slogan': { en: 'We guide, You decide', ko: 'We guide, You decide', my: 'We guide, You decide' },
  'about.cta.note': { en: 'Our story started with visa information. Begin by checking the information you need for yourself.', ko: '우리의 이야기도 비자 정보를 직접 확인하는 일에서 시작됐습니다. 먼저 필요한 비자 정보를 살펴보세요.', my: 'ကျွန်ုပ်တို့၏ ဇာတ်လမ်းလည်း ဗီဇာအချက်အလက်ကို ကိုယ်တိုင်စစ်ဆေးခြင်းမှ စတင်ခဲ့ပါသည်။ ဦးစွာ သင်လိုအပ်သော ဗီဇာအချက်အလက်ကို ကြည့်ရှုပါ။' },
