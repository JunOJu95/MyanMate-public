...
export const ui = {
  ...
  'btn.organizeVisa': { en: 'Request my checklist', ko: '내 상황에 맞게 정리받기', my: 'လမ်းညွှန် တောင်းရန်' },
  ...
  'home.hero.sub': { en: 'Start with the visa information already organized here. We will keep adding more visa topics. If reviewing the public requirements for your situation takes too much time, you can request checklist guidance.', ko: '먼저 정리된 비자 정보를 확인해 보세요. 필요한 비자 정보는 계속 추가할 예정입니다. 공개 요건을 내 상황에 맞게 다시 확인하고 정리할 시간이 부족하다면 체크리스트 안내를 요청할 수 있습니다.', my: 'ဤနေရာတွင် စီစဉ်ထားသော ဗီဇာအချက်အလက်များကို ဦးစွာ စစ်ဆေးပါ။ လိုအပ်သော ဗီဇာအကြောင်းအရာများကို ဆက်လက်ထည့်သွင်းသွားပါမည်။ သင့်အခြေအနေအတွက် အများပြည်သူသိနိုင်သော လိုအပ်ချက်များကို ပြန်လည်စစ်ဆေးရန် အချိန်မလုံလောက်ပါက စစ်ဆေးစာရင်းလမ်းညွှန်မှုကို တောင်းဆိုနိုင်ပါသည်။' },
  ...
  'home.visaService.eyebrow': { en: 'Paid checklist guidance', ko: '유료 체크리스트 안내', my: 'အခပေး စစ်ဆေးစာရင်းလမ်းညွှန်မှု' },
  'home.visaService.title': { en: 'Short on time to organize it for your situation?', ko: '내 상황에 맞게 다시 정리할 시간이 부족한가요?', my: 'သင့်အခြေအနေအလိုက် ပြန်လည်စီစဉ်ရန် အချိန်မလုံလောက်ပါသလား?' },
  'home.visaService.body': { en: 'Tell us only the context needed for your question. We research public requirements and organize a checklist you can use while completing the required steps yourself.', ko: '문의에 필요한 상황만 알려주세요. 공개 요건을 조사해 본인이 직접 필수 절차를 진행할 때 사용할 체크리스트로 정리합니다.', my: 'မေးခွန်းအတွက် လိုအပ်သောအခြေအနေကိုသာ ပြောပြပါ။ အများပြည်သူသိနိုင်သော လိုအပ်ချက်များကို ရှာဖွေပြီး သင်ကိုယ်တိုင် လိုအပ်သောအဆင့်များ ဆောင်ရွက်ရာတွင် အသုံးပြုနိုင်သည့် စစ်ဆေးစာရင်းအဖြစ် စီစဉ်ပေးပါသည်။' },
  'home.visaService.outcomesTitle': { en: 'Included in the guidance', ko: '안내에 포함되는 내용', my: 'လမ်းညွှန်မှုတွင် ပါဝင်သောအရာများ' },
  'home.visaService.outcome.requirements': { en: 'Public requirements for your stated situation', ko: '알려주신 상황에 적용되는 공개 요건', my: 'သင်ပြောပြသောအခြေအနေနှင့် သက်ဆိုင်သည့် အများပြည်သူသိနိုင်သောလိုအပ်ချက်များ' },
  'home.visaService.outcome.checklist': { en: 'A situation-specific document checklist', ko: '상황별 준비 서류 체크리스트', my: 'အခြေအနေအလိုက် စာရွက်စာတမ်းစစ်ဆေးစာရင်း' },
  'home.visaService.outcome.sources': { en: 'Official sources to confirm', ko: '최종 확인할 공식 출처', my: 'နောက်ဆုံးစစ်ဆေးရန် တရားဝင်ရင်းမြစ်များ' },
  'home.visaService.outcome.order': { en: 'A clear preparation order', ko: '헷갈리지 않는 준비 순서', my: 'ရှင်းလင်းသော ပြင်ဆင်မှုအစီအစဉ်' },
  'home.visaService.outcome.questions': { en: 'Questions you should verify yourself', ko: '본인이 직접 확인해야 할 질문', my: 'သင်ကိုယ်တိုင် အတည်ပြုရမည့် မေးခွန်းများ' },
  ...
  'svc.housing.desc': { en: 'We accompany you to up to three homes that you found and booked yourself through a licensed realtor. We check visible conditions and the surrounding living environment, then organize an honest comparison and personal opinion.', ko: '고객이 공인중개사를 통해 직접 찾고 예약한 집을 최대 3곳까지 함께 봅니다. 눈에 보이는 집 상태와 주변 생활환경을 확인하고, 솔직한 비교와 개인 의견을 정리해 드립니다.', my: 'လိုင်စင်ရ အိမ်ခြံမြေအကျိုးဆောင်မှတစ်ဆင့် သင်ကိုယ်တိုင် ရှာဖွေပြီး ကြိုတင်ချိန်းထားသော အိမ် ၃ လုံးအထိ အတူလိုက်ကြည့်ပါသည်။ မြင်နိုင်သော အိမ်အခြေအနေနှင့် ပတ်ဝန်းကျင်ကို စစ်ဆေးပြီး ရိုးသားသော နှိုင်းယှဉ်ချက်နှင့် ကိုယ်ပိုင်အမြင်ကို စီစဉ်ပေးပါသည်။' },
  'svc.housing.price': { en: '₩150,000 · up to 3 homes', ko: '15만원 · 최대 3곳', my: '₩150,000 · အိမ် ၃ လုံးအထိ' },
  'svc.housing.duration': { en: 'Up to 3 hours', ko: '최대 3시간', my: '၃ နာရီအထိ' },
  'svc.housing.deliverables.title': { en: 'What you receive', ko: '이런 내용을 제공해요', my: 'သင်ရရှိမည့် အရာများ' },
  'svc.housing.deliverable.notes': { en: 'Notes for each home, plus photos where the realtor or property owner permits them', ko: '집별 메모와 공인중개사·임대인이 허용한 범위의 사진', my: 'အိမ်တစ်လုံးစီအတွက် မှတ်စုများနှင့် အိမ်ခြံမြေအကျိုးဆောင် သို့မဟုတ် အိမ်ရှင်ခွင့်ပြုသည့် ဓာတ်ပုံများ' },
  'svc.housing.deliverable.condition': { en: 'A visible-condition checklist covering light, mold, odor, noise, water pressure, and cleanliness', ko: '채광·곰팡이·냄새·소음·수압·청결 상태 체크리스트', my: 'အလင်းရောင်၊ မှို၊ အနံ့၊ ဆူညံသံ၊ ရေဖိအားနှင့် သန့်ရှင်းမှု စစ်ဆေးစာရင်း' },
  'svc.housing.deliverable.access': { en: 'A comparison of access to transit, markets, hospitals, and work', ko: '역·마트·병원·직장 접근성 비교', my: 'ဘူတာ၊ စျေး၊ ဆေးရုံနှင့် အလုပ်နေရာသို့ သွားလာရလွယ်ကူမှု နှိုင်းယှဉ်ချက်' },
  'svc.housing.deliverable.costs': { en: 'A summary of rent, maintenance fees, and other terms presented by the licensed realtor', ko: '공인중개사가 제시한 월세·관리비 등 조건 정리', my: 'လိုင်စင်ရ အိမ်ခြံမြေအကျိုးဆောင်က တင်ပြသော လစဉ်ငှားရမ်းခ၊ စီမံခန့်ခွဲခနှင့် အခြားအခြေအနေများ အကျဉ်းချုပ်' },
  'svc.housing.deliverable.compare': { en: 'A side-by-side comparison of the advantages and disadvantages of up to three homes', ko: '최대 세 집의 장단점 비교표', my: 'အိမ် ၃ လုံးအထိ အားသာချက်နှင့် အားနည်းချက် နှိုင်းယှဉ်ဇယား' },
  'svc.housing.deliverable.opinion': { en: 'An honest personal opinion to support your own final decision', ko: '본인의 최종 결정을 돕는 솔직한 개인 의견', my: 'သင်ကိုယ်တိုင် နောက်ဆုံးဆုံးဖြတ်နိုင်ရန် ရိုးသားသော ကိုယ်ပိုင်အမြင်' },
  'svc.housing.pricing.title': { en: 'Pricing', ko: '요금 안내', my: 'အခကြေးငွေ' },
  'svc.housing.pricing.lead': { en: 'The fee is based on the companion session, not on whether you sign a lease.', ko: '계약 성사가 아니라 동행 세션의 주택 수와 시간에 따라 요금이 정해집니다.', my: 'အခကြေးငွေသည် စာချုပ်ချုပ်ဆိုမှုအပေါ် မူတည်ခြင်းမဟုတ်ဘဲ အတူလိုက်ကြည့်သည့် အိမ်အရေအတွက်နှင့် အချိန်ပေါ် မူတည်ပါသည်။' },
  'svc.housing.pricing.base': { en: 'Base companion session · ₩150,000', ko: '기본 동행료 · 150,000원', my: 'အခြေခံ အတူလိုက်ခ · ₩150,000' },
  'svc.housing.pricing.included': { en: 'Includes up to 3 homes and up to 3 hours', ko: '고객이 직접 예약한 주택 최대 3곳 · 최대 3시간 포함', my: 'သင်ကိုယ်တိုင် ကြိုတင်ချိန်းထားသော အိမ် ၃ လုံးနှင့် ၃ နာရီအထိ ပါဝင်သည်' },
  'svc.housing.pricing.regardless': { en: 'The same fee applies whether or not you sign a lease', ko: '임대차 계약 여부와 관계없이 동일한 요금 적용', my: 'ငှားရမ်းစာချုပ် ချုပ်ဆိုသည်ဖြစ်စေ မချုပ်ဆိုသည်ဖြစ်စေ တူညီသော အခကြေးငွေ သတ်မှတ်ပါသည်' },
  'svc.housing.pricing.extraHome': { en: 'Each additional home · ₩40,000', ko: '추가 주택 1곳당 · 40,000원', my: 'အပိုအိမ် တစ်လုံးလျှင် · ₩40,000' },
  'svc.housing.pricing.overtime': { en: 'Each additional 30 minutes · ₩20,000', ko: '30분 초과 시 · 20,000원', my: 'အပို ၃၀ မိနစ်လျှင် · ₩20,000' },
  'svc.housing.pricing.travel': { en: 'Customer pays long-distance travel and taxi costs separately · explained and agreed before use', ko: '집 간 장거리 이동비·택시비는 고객 별도 부담 · 이용 전 안내 및 동의', my: 'အိမ်များအကြား ခရီးဝေးသွားလာစရိတ်နှင့် တက္ကစီခကို ဖောက်သည်က သီးခြားပေးရပြီး အသုံးမပြုမီ ရှင်းပြကာ သဘောတူညီမှု ရယူပါသည်' },
  'svc.housing.confirm.title': { en: 'Please confirm before requesting', ko: '신청 전에 모두 확인해 주세요', my: 'တောင်းဆိုမီ အားလုံးကို အတည်ပြုပါ' },
  'svc.housing.confirm.lead': { en: 'Every item below defines the boundary of this service. All confirmations are required when requesting home-viewing guidance.', ko: '아래 내용은 서비스의 필수 운영 범위입니다. 집 보기 동행 서비스를 신청하려면 모든 항목을 확인해야 합니다.', my: 'အောက်ပါအချက်များသည် ဤဝန်ဆောင်မှု၏ မဖြစ်မနေ လုပ်ငန်းနယ်ပယ်ဖြစ်ပါသည်။ အိမ်ကြည့်အတူလိုက်ဝန်ဆောင်မှု တောင်းဆိုရန် အချက်အားလုံးကို အတည်ပြုရပါမည်။' },
  'svc.housing.confirm.selfBooked': { en: 'I find, choose, and book every home myself through a licensed realtor.', ko: '매물 찾기·선택·방문 예약은 이용자 본인이 공인중개사를 통해 직접 진행합니다.', my: 'အိမ်ရှာဖွေခြင်း၊ ရွေးချယ်ခြင်းနှင့် ကြည့်ရှုရန် ချိန်းဆိုခြင်းအားလုံးကို လိုင်စင်ရ အိမ်ခြံမြေအကျိုးဆောင်မှတစ်ဆင့် ကျွန်ုပ်ကိုယ်တိုင် လုပ်ဆောင်ပါသည်။' },
  'svc.housing.confirm.noListings': { en: 'MyanMate does not provide, connect, or advertise property listings.', ko: 'MyanMate는 매물을 소개·연결·광고하지 않습니다.', my: 'MyanMate သည် အိမ်ခန်းစာရင်းများကို မိတ်ဆက်ခြင်း၊ ချိတ်ဆက်ခြင်း သို့မဟုတ် ကြော်ငြာခြင်း မပြုပါ။' },
  'svc.housing.confirm.noNegotiation': { en: 'MyanMate does not negotiate the deposit, rent, repairs, or move-in date.', ko: 'MyanMate는 보증금·월세·수리·입주일을 협상하지 않습니다.', my: 'MyanMate သည် အာမခံငွေ၊ လစဉ်ငှားရမ်းခ၊ ပြုပြင်မှု သို့မဟုတ် ဝင်ရောက်နေထိုင်မည့်ရက်ကို ညှိနှိုင်းမပေးပါ။' },
  'svc.housing.confirm.noContractReview': { en: 'MyanMate does not write or review contracts and does not guarantee legal rights or property safety.', ko: 'MyanMate는 계약서를 작성·검토하지 않고 권리관계나 주택의 법적 안전성을 보증하지 않습니다.', my: 'MyanMate သည် စာချုပ်ရေးသားခြင်း သို့မဟုတ် စစ်ဆေးခြင်း မပြုဘဲ ဥပဒေဆိုင်ရာ အခွင့်အရေး သို့မဟုတ် အိမ်၏ ဥပဒေဆိုင်ရာ လုံခြုံမှုကို အာမမခံပါ။' },
  'svc.housing.confirm.visibleOnly': { en: 'The check covers visible conditions and the surrounding living environment only.', ko: '체크 대상은 눈으로 확인 가능한 상태와 주변 생활환경에 한정됩니다.', my: 'စစ်ဆေးမှုသည် မျက်စိဖြင့် မြင်နိုင်သော အခြေအနေနှင့် ပတ်ဝန်းကျင်နေထိုင်မှုအခြေအနေများသာ ပါဝင်ပါသည်။' },
  'svc.housing.confirm.feeRegardless': { en: 'The companion fee applies regardless of whether I sign a lease.', ko: '임대차 계약 체결 여부와 관계없이 동행료가 발생합니다.', my: 'ငှားရမ်းစာချုပ် ချုပ်ဆိုသည်ဖြစ်စေ မချုပ်ဆိုသည်ဖြစ်စေ အတူလိုက်ပါခကို ပေးရပါမည်။' },
  'svc.housing.confirm.noReferralFee': { en: 'MyanMate does not receive referral fees from realtors or property owners.', ko: 'MyanMate는 공인중개사·임대인으로부터 소개비를 받지 않습니다.', my: 'MyanMate သည် အိမ်ခြံမြေအကျိုးဆောင် သို့မဟုတ် အိမ်ရှင်ထံမှ မိတ်ဆက်ခ မရယူပါ။' },
  'svc.housing.how.step1': { en: 'You find and choose up to three homes through a licensed realtor and complete the viewing bookings yourself.', ko: '공인중개사를 통해 볼 집을 최대 3곳까지 직접 찾고 선택한 뒤 방문 예약을 완료합니다.', my: 'လိုင်စင်ရ အိမ်ခြံမြေအကျိုးဆောင်မှတစ်ဆင့် ကြည့်မည့်အိမ် ၃ လုံးအထိ ကိုယ်တိုင်ရှာဖွေရွေးချယ်ပြီး ချိန်းဆိုမှု ပြီးစီးပါသည်။' },
  'svc.housing.how.step2': { en: 'Send us the meeting place, schedule, and the practical points you care about.', ko: '만날 장소와 일정, 중요하게 생각하는 생활 조건을 알려주세요.', my: 'တွေ့ဆုံမည့်နေရာ၊ အချိန်ဇယားနှင့် သင်အရေးထားသော နေထိုင်မှုအချက်များကို ပြောပြပါ။' },
  'svc.housing.how.step3': { en: 'We meet you and the licensed realtor and view the booked homes together.', ko: '약속 장소에서 고객과 공인중개사를 만나 예약된 집을 함께 봅니다.', my: 'ချိန်းထားသောနေရာတွင် သင်နှင့် လိုင်စင်ရ အိမ်ခြံမြေအကျိုးဆောင်ကို တွေ့ဆုံပြီး ကြိုတင်ချိန်းထားသော အိမ်များကို အတူကြည့်ပါသည်။' },
  'svc.housing.how.step4': { en: 'We record visible conditions, access, and the surrounding living environment using the checklist.', ko: '체크리스트로 눈에 보이는 집 상태와 접근성, 주변 생활환경을 기록합니다.', my: 'စစ်ဆေးစာရင်းဖြင့် မြင်နိုင်သော အိမ်အခြေအနေ၊ သွားလာရလွယ်ကူမှုနှင့် ပတ်ဝန်းကျင်ကို မှတ်တမ်းတင်ပါသည်။' },
  'svc.housing.how.step5': { en: 'After the viewings, we organize the differences, advantages, disadvantages, and our personal opinion.', ko: '집을 모두 본 뒤 차이점과 장단점, 개인 의견을 비교해 정리합니다.', my: 'အိမ်များအားလုံး ကြည့်ပြီးနောက် ကွာခြားချက်များ၊ အားသာချက်၊ အားနည်းချက်နှင့် ကိုယ်ပိုင်အမြင်ကို နှိုင်းယှဉ်စီစဉ်ပါသည်။' },
  'svc.housing.how.step6': { en: 'You make the final decision and handle any negotiation, legal checks, and contract directly with the licensed realtor or another qualified professional.', ko: '최종 결정과 조건 협상, 권리 확인, 계약은 본인이 공인중개사 또는 자격 전문가와 직접 진행합니다.', my: 'နောက်ဆုံးဆုံးဖြတ်ချက်၊ အခြေအနေညှိနှိုင်းမှု၊ အခွင့်အရေးစစ်ဆေးမှုနှင့် စာချုပ်ကို သင်ကိုယ်တိုင် လိုင်စင်ရ အိမ်ခြံမြေအကျိုးဆောင် သို့မဟုတ် ကျွမ်းကျင်သူနှင့် တိုက်ရိုက် ဆောင်ရွက်ပါသည်။' },
  'svc.housing.faq.q1': { en: 'Who finds and books the homes?', ko: '집은 누가 찾고 예약하나요?', my: 'အိမ်များကို ဘယ်သူရှာပြီး ချိန်းဆိုပါသလဲ?' },
  'svc.housing.faq.a1': { en: 'You do. Choose a licensed realtor, select every home, and complete all viewing bookings before requesting our companion service.', ko: '고객이 직접 합니다. 공인중개사를 선택하고 볼 집과 방문 일정을 모두 확정한 뒤 동행 서비스를 요청해 주세요.', my: 'သင်ကိုယ်တိုင် လုပ်ဆောင်ပါသည်။ လိုင်စင်ရ အိမ်ခြံမြေအကျိုးဆောင်ကို ရွေးချယ်ပြီး အိမ်နှင့် ကြည့်ရှုမည့်အချိန်များကို အတည်ပြုပြီးမှ ကျွန်ုပ်တို့၏ အတူလိုက်ဝန်ဆောင်မှုကို တောင်းဆိုပါ။' },
  'svc.housing.faq.q2': { en: 'What if I do not sign a lease?', ko: '계약하지 않아도 비용이 발생하나요?', my: 'စာချုပ်မချုပ်လျှင်လည်း အခကြေးငွေ ပေးရပါသလား?' },
  'svc.housing.faq.a2': { en: 'The ₩150,000 fee is for the companion session, checklist, and comparison. It applies regardless of whether you sign a lease.', ko: '15만원은 동행, 체크리스트, 비교 정리에 대한 비용입니다. 임대차 계약 체결 여부와 관계없이 동일하게 발생합니다.', my: '₩150,000 သည် အတူလိုက်ခြင်း၊ စစ်ဆေးစာရင်းနှင့် နှိုင်းယှဉ်စီစဉ်မှုအတွက် ဖြစ်ပြီး စာချုပ်ချုပ်ဆိုသည်ဖြစ်စေ မချုပ်ဆိုသည်ဖြစ်စေ ပေးရပါမည်။' },
  'svc.housing.faq.q3': { en: 'What if I want to view more than three homes?', ko: '집을 3곳보다 더 보고 싶으면 어떻게 하나요?', my: 'အိမ် ၃ လုံးထက်ပိုကြည့်လိုပါက ဘယ်လိုလုပ်ရမလဲ?' },
  'svc.housing.faq.a3': { en: 'Additional homes or time are charged separately. We confirm the extra fee before the session continues.', ko: '추가 방문이나 초과 시간은 별도 요금입니다. 계속 진행하기 전에 추가 비용을 먼저 확인합니다.', my: 'အပိုအိမ်ကြည့်ခြင်း သို့မဟုတ် အချိန်ပိုအတွက် သီးခြားအခကြေးငွေ ရှိပြီး ဆက်လက်မလုပ်မီ အပိုကုန်ကျစရိတ်ကို အတည်ပြုပါသည်။' },
  'svc.housing.faq.q4': { en: 'Who pays transportation costs?', ko: '이동비는 누가 부담하나요?', my: 'သွားလာစရိတ်ကို ဘယ်သူပေးရပါသလဲ?' },
  'svc.housing.faq.a4': { en: 'Regular public transportation is included in the base fee. If long-distance travel between homes or a taxi is needed, the customer pays that cost separately. We explain the expected cost and get your agreement before using a taxi. Where possible, you call and pay for the taxi directly; if MyanMate pays first, we charge only the actual amount shown on the receipt.', ko: '일반 대중교통비는 기본요금에 포함됩니다. 집 간 장거리 이동이나 택시가 필요한 경우에는 고객이 별도로 부담합니다. 택시는 예상 비용과 이용 방법을 먼저 안내하고 고객의 동의를 받은 뒤 이용합니다. 가능하면 고객이 직접 호출·결제하며, MyanMate가 먼저 결제한 경우 영수증에 표시된 실비만 청구합니다.', my: 'ပုံမှန် အများပြည်သူသယ်ယူပို့ဆောင်ရေးစရိတ်ကို အခြေခံအခကြေးငွေတွင် ထည့်သွင်းထားပါသည်။ အိမ်များအကြား ခရီးဝေးသွားလာမှု သို့မဟုတ် တက္ကစီလိုအပ်ပါက ဖောက်သည်က သီးခြားပေးရပါမည်။ တက္ကစီအသုံးမပြုမီ မျှော်မှန်းကုန်ကျစရိတ်နှင့် အသုံးပြုပုံကို ရှင်းပြပြီး သဘောတူညီမှု ရယူပါသည်။ ဖြစ်နိုင်လျှင် ဖောက်သည်က တက္ကစီကို ကိုယ်တိုင်ခေါ်၍ ပေးချေပြီး MyanMate က အရင်ပေးချေပါက ပြေစာတွင် ဖော်ပြထားသော အမှန်တကယ်ကုန်ကျစရိတ်ကိုသာ ကောက်ခံပါသည်။' },
  ...
  'content.cta.visa.eyebrow': { en: 'personal checklist guidance', ko: '맞춤 체크리스트 안내', my: 'အခြေအနေအလိုက် စစ်ဆေးစာရင်းလမ်းညွှန်မှု' },
  'content.cta.visa.title': { en: 'Request checklist guidance for your situation', ko: '내 상황 기준 체크리스트 안내 요청', my: 'သင့်အခြေအနေအတွက် စစ်ဆေးစာရင်းလမ်းညွှန်မှု တောင်းဆိုရန်' },
  ...
  'content.cta.visa.body': { en: 'We research public requirements and organize a checklist for the context you share. You complete the application and submission yourself.', ko: '알려주신 상황을 기준으로 공개 요건을 조사해 체크리스트로 정리합니다. 신청과 제출은 본인이 직접 진행합니다.', my: 'သင်ပြောပြသောအခြေအနေကို အခြေခံ၍ အများပြည်သူသိနိုင်သော လိုအပ်ချက်များကို ရှာဖွေပြီး စစ်ဆေးစာရင်းအဖြစ် စီစဉ်ပေးပါသည်။ လျှောက်ထားခြင်းနှင့် တင်သွင်းခြင်းကို သင်ကိုယ်တိုင် ဆောင်ရွက်ပါသည်။' },
  'content.cta.visa.button': { en: 'Request checklist guidance', ko: '체크리스트 안내 요청하기', my: 'စစ်ဆေးစာရင်းလမ်းညွှန်မှု တောင်းဆိုရန်' },
  ...
  'request.field.visa':       { en: 'Which visa are you checking?', ko: '확인 중인 비자', my: 'မည်သည့်ဗီဇာကို စစ်ဆေးနေပါသလဲ?' },
  'request.field.visa.ph':    { en: 'Choose a visa', ko: '비자 선택', my: 'ဗီဇာ ရွေးပါ' },
  'request.field.visa.note':  { en: 'Choose only the visa type. Do not enter passport or ID numbers.', ko: '비자 종류만 선택해 주세요. 여권번호나 외국인등록번호는 필요하지 않습니다.', my: 'ဗီဇာအမျိုးအစားကိုသာ ရွေးပါ။ ပတ်စပို့ သို့မဟုတ် ID နံပါတ် မလိုအပ်ပါ။' },
