...
export const ui = {
  ...
  'infoHub.intro': { en: 'Browse practical information for settling in Korea, from visas, job preparation, and housing to employment terms, healthcare, and everyday administration. Open the category closest to what you need now.', ko: '비자와 구직 준비, 집·주거환경부터 근로조건, 건강보험·병원, 생활 행정까지 한국 정착에 필요한 실용 정보를 모았습니다. 지금 필요한 내용과 가장 가까운 카테고리부터 확인하세요.', my: 'ဗီဇာ၊ အလုပ်လျှောက်ရန်ပြင်ဆင်မှုနှင့် နေထိုင်ရာမှ အလုပ်စည်းကမ်း၊ ကျန်းမာရေးအာမခံနှင့် ဆေးရုံ၊ နေ့စဉ်အုပ်ချုပ်ရေးလုပ်ငန်းများအထိ ကိုရီးယားတွင် အခြေချနေထိုင်ရန် လိုအပ်သော လက်တွေ့အချက်အလက်များကို စုစည်းထားပါသည်။ ယခုလိုအပ်သောအကြောင်းအရာနှင့် အနီးစပ်ဆုံး အမျိုးအစားကို ဖွင့်ကြည့်ပါ။' },
  ...
  'infoTopic.contents': { en: 'Jump to a section', ko: '필요한 내용 바로가기', my: 'လိုအပ်သောအပိုင်းသို့ တိုက်ရိုက်သွားရန်' },
  'infoTopic.audience.general': { en: 'If you completed foreigner registration', ko: '외국인등록을 했다면', my: 'နိုင်ငံခြားသားမှတ်ပုံတင်ထားပါက' },
  'infoTopic.audience.student': { en: 'Students', ko: '학생이라면', my: 'ကျောင်းသားဆိုလျှင်' },
  'infoTopic.audience.worker': { en: 'If you are working', ko: '근로 중이라면', my: 'အလုပ်လုပ်နေပါက' },
  'infoTopic.audience.ifApplicable': { en: 'Only if relevant', ko: '해당하는 경우만', my: 'သက်ဆိုင်မှသာ' },
  'infoTopic.audience.warning': { en: 'Confirm before acting', ko: '진행 전 확인', my: 'မလုပ်မီ အတည်ပြုပါ' },
  'infoTopic.audience.official': { en: 'Official source', ko: '공식 확인처', my: 'တရားဝင်အတည်ပြုရာ' },
  'infoTopic.prepare': { en: 'Prepare', ko: '준비할 것', my: 'ပြင်ဆင်ရန်' },
  'infoTopic.steps': { en: 'Do this yourself', ko: '직접 진행할 순서', my: 'ကိုယ်တိုင်လုပ်ဆောင်ရန် အဆင့်များ' },
  'infoTopic.checklist': { en: 'Final checks', ko: '마지막 확인', my: 'နောက်ဆုံး စစ်ဆေးရန်' },
  'infoTopic.checklist.note': { en: 'Checks last only while this page is open. They are personal reminders, not proof that an official procedure is complete.', ko: '체크 상태는 이 페이지를 열어둔 동안만 유지됩니다. 개인 확인용이며 공식 절차 완료 증빙이 아닙니다.', my: 'ဤစာမျက်နှာဖွင့်ထားချိန်တွင်သာ အမှန်ခြစ်များ ကျန်ရှိပါမည်။ ကိုယ်ပိုင်မှတ်သားရန်သာဖြစ်ပြီး တရားဝင်လုပ်ငန်းပြီးစီးကြောင်း သက်သေမဟုတ်ပါ။' },
  'infoTopic.doneWhen': { en: 'How to know it is complete', ko: '완료 확인 기준', my: 'ပြီးစီးကြောင်း စစ်ဆေးရန်' },
  'infoTopic.details': { en: 'Read the details and exceptions', ko: '상세 기준과 예외 보기', my: 'အသေးစိတ်စံနှင့် ခြွင်းချက်များ ကြည့်ရန်' },
  'infoTopic.template': { en: 'Korean message you can send yourself', ko: '직접 문의할 때 쓸 한국어 문장', my: 'ကိုယ်တိုင်မေးမြန်းရန် ကိုရီးယားစာသား' },
  'infoTopic.template.copy': { en: 'Copy Korean message', ko: '한국어 문장 복사', my: 'ကိုရီးယားစာသားကို ကူးယူရန်' },
  'infoTopic.template.copied': { en: 'Copied', ko: '복사했어요', my: 'ကူးယူပြီးပါပြီ' },
  'infoTopic.template.meaning': { en: 'See the meaning in your language', ko: '현재 언어로 뜻 보기', my: 'မိမိဘာသာစကားဖြင့် အဓိပ္ပါယ်ကြည့်ရန်' },
  'infoTopic.sources': { en: 'Related official places to check', ko: '관련 공식 확인처', my: 'သက်ဆိုင်ရာ တရားဝင်စစ်ဆေးရန်နေရာများ' },
  'infoTopic.source.open': { en: 'Open official source', ko: '공식 페이지 열기', my: 'တရားဝင်စာမျက်နှာ ဖွင့်ရန်' },
  'infoTopic.jump': { en: 'Go to this part', ko: '해당 내용으로 이동', my: 'သက်ဆိုင်ရာအပိုင်းသို့ သွားရန်' },
