...
export const ui = {
  ...
  'nav.blog':      { en: 'Blog',     ko: '블로그',  my: 'Blog' },
  ...
  'home.information.study.title': { en: 'Study information', ko: '유학 정보', my: 'ပညာသင် အချက်အလက်' },
  'home.information.study.summary': { en: 'Start with TOPIK, KIIP, scholarships, university choice, application preparation, and student-life checks.', ko: 'TOPIK, KIIP, 장학금, 학교 선택, 지원 준비와 유학생 생활 확인사항부터 살펴보세요.', my: 'TOPIK၊ KIIP၊ Scholarship၊ ကျောင်းရွေးချယ်မှု၊ လျှောက်ထားရန်ပြင်ဆင်မှုနှင့် ကျောင်းသားဘဝ စစ်ဆေးရန်အချက်များကို အရင်ကြည့်ပါ။' },
  'home.information.dailyLife.title': { en: 'Daily life information', ko: '생활 정보', my: 'နေ့စဉ်ဘဝ အချက်အလက်' },
  'home.information.dailyLife.summary': { en: 'Check address changes, phone and SIM cards, transportation, emergency numbers, healthcare, and everyday Korea life.', ko: '주소 변경, 휴대폰·SIM, 교통, 긴급 연락처, 건강보험과 한국 생활 정보를 확인하세요.', my: 'လိပ်စာပြောင်းခြင်း၊ ဖုန်းနှင့် SIM ကတ်၊ သွားလာရေး၊ အရေးပေါ်နံပါတ်၊ ကျန်းမာရေးနှင့် ကိုရီးယားနေ့စဉ်ဘဝအချက်အလက်များကို စစ်ပါ။' },
  ...
  'services.coming.kicker': { en: 'MyanMate Services', ko: 'MyanMate 서비스', my: 'MyanMate Services' },
  'services.coming.title': { en: 'Our services are coming soon.....', ko: '서비스를 준비 중입니다.....', my: 'Our services are coming soon.....' },
  'services.coming.description': { en: 'MyanMate is currently focusing on publishing useful information first. We are preparing the services in detail and will open them soon.', ko: '현재 MyanMate는 필요한 정보를 먼저 제공하고 있습니다. 서비스는 자세히 준비한 뒤 곧 오픈하겠습니다.', my: 'လက်ရှိတွင် MyanMate သည် အချက်အလက်များကို ဦးစားပေးတင်ဆက်နေပါသည်။ ဝန်ဆောင်မှုများကို အသေးစိတ်ပြင်ဆင်ပြီး မကြာမီ ဖွင့်လှစ်ပါမည်။' },
  'services.coming.guides': { en: 'Read information', ko: '정보 읽기', my: 'အချက်အလက်များ ဖတ်ရန်' },
  'services.coming.contact': { en: 'If you have a question, you can send a message from Contact.', ko: '궁금한 점이 있으면 Contact에서 메시지를 보내실 수 있습니다.', my: 'မေးလိုသည့်အချက်ရှိပါက Contact မှ မက်ဆေ့ပို့နိုင်ပါသည်။' },
  ...
  /* 3b. Blog */
  'blog.title':         { en: 'Blog', ko: '블로그', my: 'Blog' },
  'blog.intro':         { en: 'Practical Korea updates for Myanmar readers.', ko: '미얀마 독자를 위한 한국 생활 정보입니다.', my: 'ကိုရီးယားလာမည့်သူများနှင့် နေထိုင်နေသူများအတွက် အသုံးဝင်သော ဆောင်းပါးများ။' },
  ...
  'blog.latest':        { en: 'Latest from the blog', ko: '블로그 최신 글', my: 'Blog မှ နောက်ဆုံးစာများ' },
  'blog.viewAll':       { en: 'View all posts', ko: '전체 글 보기', my: 'စာအားလုံး ကြည့်ရန်' },
  'blog.back':          { en: 'Back to Blog', ko: '블로그로 돌아가기', my: 'Blog သို့ ပြန်သွားရန်' },
