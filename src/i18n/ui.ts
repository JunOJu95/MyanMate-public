...
export const ui = {
  ...
  'home.about.blurb':    { en: 'MyanMate was created by a Korean co-founder who understands local systems and context, and a Myanmar co-founder who has navigated five years of settling in Korea firsthand.', ko: 'MyanMate는 한국의 제도와 현지 맥락을 아는 한국인 공동창업자와, 5년간 한국 정착을 직접 겪은 미얀마 출신 공동창업자가 함께 만들었습니다.', my: 'MyanMate ကို ကိုရီးယားစနစ်နှင့် ဒေသတွင်းအခြေအနေကို နားလည်သော ကိုရီးယားပူးတွဲတည်ထောင်သူနှင့် ကိုရီးယားတွင် ၅ နှစ်ကြာ ကိုယ်တိုင်အခြေချနေထိုင်ခဲ့သော မြန်မာပူးတွဲတည်ထောင်သူတို့ အတူဖန်တီးခဲ့ပါသည်။' },
  ...
  'about.cta.note': { en: 'Start with the guides. If your situation is still unclear, choose a DM channel and ask without sending sensitive information.', ko: '먼저 정보를 확인해 보세요. 그래도 내 상황이 불확실하다면 민감정보 없이 편한 DM 채널로 문의하세요.', my: 'လမ်းညွှန်ချက်များဖြင့် စတင်ပါ။ သင့်အခြေအနေမှာ မသေချာသေးပါက DM channel တစ်ခုကို ရွေးချယ်ပြီး အရေးကြီးကိုယ်ရေးအချက်အလက်များ မပို့ဘဲ မေးမြန်းပါ။' },
