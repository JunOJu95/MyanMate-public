...
export const ui = {
  ...
  'home.information.all.title': { en: 'All Korea-life articles', ko: '한국 생활 전체 글', my: 'ကိုရီးယားဘဝ ဆောင်းပါးအားလုံး' },
  'home.information.all.summary': { en: 'Browse every article on visas, work, housing, Korean expressions, and daily life in newest-first order.', ko: '비자, 일자리, 주거, 생활 한국어와 일상 정보를 최신순으로 둘러보세요.', my: 'ဗီဇာ၊ အလုပ်၊ နေအိမ်၊ ကိုရီးယားစကားနှင့် နေ့စဉ်ဘဝအကြောင်း ဆောင်းပါးအားလုံးကို အသစ်ဆုံးမှ စ၍ ကြည့်ရှုပါ။' },
  ...
  'home.process.step3.body': { en: 'Choose Telegram, TikTok, or Messenger and ask without sending sensitive numbers.', ko: 'Telegram, TikTok, Messenger 중 편한 채널에서 민감번호 없이 문의합니다.', my: 'Telegram၊ TikTok သို့မဟုတ် Messenger မှ အဆင်ပြေသော channel ကိုရွေးပြီး အရေးကြီးနံပါတ်များမပို့ဘဲ မေးပါ။' },
